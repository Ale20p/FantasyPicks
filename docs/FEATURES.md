...
1) Player data:
	...
	5) League Type: Users can select what type of league they are drafting for. Which results in the corresponding data being scraped from the sources selected. League types:(Need to be non-superflex)
		- 1 PPR
		- 0.5 PPR
		- Non-PPR/Standard
